    ...
    <div class="card page-card w-100">
        <div class="card-body p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h5 class="mb-1 fw-semibold">Proveedores</h5>
            ...
            <div class="d-flex justify-content-between align-items-center gap-3 mb-4 flex-wrap">
                <div style="position:relative; flex:1; max-width:320px;">
                    ...
                    <input type="text" id="buscadorProveedores" class="form-control"
                        placeholder="Buscar por nombre, RNC o contacto..." style="padding-left:36px;"
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle">
                    ...
                    <tbody id="tablaContainer" data-url="{{ route('proveedores.index') }}">

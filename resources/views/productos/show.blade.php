            ...
            <div class="card page-card">
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="field-readonly" style="font-family:monospace; font-size:13px;">
                            {{ $producto->codigo }}
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    @permiso('productos.gestionar')
                        <div class="d-flex gap-2 mt-4">
                            <a href="{{ route('productos.edit', $producto) }}" class="btn btn-primary flex-fill">
                            ...
                            <tbody>
                                @forelse($producto->variantes as $variante)
                                    <tr>
                                        ...
                                        <td>
                                            @forelse($variante->stock as $stock)
                                                @php
                                                    $nivel =
                                                        $stock->cantidad_disponible <= 0
                                                            ? ['color' => 'var(--accent)', 'icono' => 'x-circle']
                                                            : ($stock->cantidad_disponible <= $stock->stock_minimo
                                                                ? [
                                                                    'color' => '#e65100',
                                                                    'icono' => 'exclamation-triangle',
                                                                ]
                                                                : ['color' => '#2e7d32', 'icono' => 'check-circle']);
                                                @endphp
                                                <div style="font-size:12px; margin-bottom:2px;">
                                                    <i class="bi bi-{{ $nivel['icono'] }}"
                                                        style="color:{{ $nivel['color'] }};"></i>

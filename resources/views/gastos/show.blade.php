                ...
                <div class="card-body p-4">
                    ...
                    @if ($cajaChica->puedeReponerNormal())
                        <form action="{{ route('caja_chica.reponer') }}" method="POST" class="mt-3">
                            @csrf
                            <div class="mb-2">
                                <select name="categoria_gasto_id" class="form-select form-select-sm" required>
                                    <option value="">Categoría para el gasto...</option>
                            ...
                            <input type="text" name="nombre" class="form-control form-control-sm mb-2"
                                placeholder="Nombre (opcional, default: Gastos de caja chica)">
                    ...
                    <form action="{{ route('caja_chica.gasto') }}" method="POST">
                        ...
                        <div class="mb-2">
                            <select name="categoria_gasto_id"
                                class="form-select form-select-sm @error('categoria_gasto_id') is-invalid @enderror">

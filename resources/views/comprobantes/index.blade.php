            ...
            @forelse($comprobantes as $comprobante)
                <div class="col-md-6">
                    <div class="comprobante-card">
                        ...
                        @php
                            $nivel = $comprobante->porcentaje_uso >= 90 ? 'nivel-alto'
                                   : ($comprobante->porcentaje_uso >= 70 ? 'nivel-medio' : 'nivel-ok');
                        @endphp
                        ...
                        <div class="d-flex gap-2 mt-3">
                            ...
                            @if($comprobante->estado)
                                <form action="{{ route('comprobantes.desactivar', $comprobante) }}"
                                      method="POST">
                                    @csrf @method('PATCH')
                            ...
                            @else
                                <form action="{{ route('comprobantes.reactivar', $comprobante) }}"
                                      method="POST">
                                    @csrf @method('PATCH')

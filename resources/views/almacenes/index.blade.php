        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex justify-content-between align-items-center gap-3 mb-4 flex-wrap">
                ...
                <div style="position:relative; flex:1; max-width:280px;">
                    ...
                    <input type="text" id="buscadorAlmacenes" class="form-control" placeholder="Buscar almacén..."
                        style="padding-left:36px;" value="{{ request('buscar') }}" autocomplete="off">
                </div>

                <div class="d-flex align-items-center gap-2 flex-wrap">
                    <select id="filtroSucursal" class="form-select form-select-sm" style="width:auto; font-size:13px;">

                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6 d-flex align-items-end">
                        <div class="form-check">
                            <input type="checkbox" name="credito_activo"
                                   class="form-check-input"
                                   id="creditoActivo" value="1"
                                   {{ old('credito_activo', $cliente->credito_activo) ? 'checked' : '' }}>

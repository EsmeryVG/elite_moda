    ...
    <div class="card page-card w-100">
        <div class="card-body p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h5 class="mb-1 fw-semibold">Descuentos</h5>
                    <p class="text-muted mb-0" style="font-size:13px;">
                        {{ $descuentos->total() }} descuentos registrados
                    </p>
                </div>
            ...
            <div class="d-flex justify-content-between align-items-center gap-3 mb-4 flex-wrap">
                ...
                <div style="position:relative; flex:1; max-width:280px;">
                    ...
                    <input type="text" id="buscadorDescuentos" class="form-control" placeholder="Buscar por nombre..."
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle">
                    <thead>
                        <tr>
                            <th>Nombre</th>
                            <th style="width:200px;">Aplica a</th>
                    ...
                    <tbody id="tablaContainer" data-url="{{ route('descuentos.index') }}">
                        @include('descuentos._tabla')
                    </tbody>
                </table>
            </div>

        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                @permiso('productos.gestionar')
                    <button class="btn btn-primary" data-open-modal="nuevoAtributo">
            ...
            <div class="d-flex justify-content-between align-items-center gap-3 mb-4 flex-wrap">
                ...
                <div style="position:relative; flex:1; max-width:320px;">
                    ...
                    <input type="text" id="buscadorAtributos" class="form-control" placeholder="Buscar atributo..."
                        style="padding-left:36px;" value="{{ request('buscar') }}" autocomplete="off">
                </div>

                <div class="d-flex gap-2">
                    <button class="btn btn-sm em-filtro {{ !request('estado') ? 'active' : '' }}" data-filtro="todos"
                        data-estado="">
                        Todos
                    </button>
                ...
                <form action="{{ route('atributos.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror"
                            placeholder="Ej: Talla, Color, Material..." value="{{ old('nombre') }}" autofocus
                            autocomplete="off">
                        @error('nombre')
                    ...
                    <div class="em-modal__actions">
                        <button type="button" class="btn btn-secondary" data-close-modal="modalNuevoAtributo">
                            Cancelar
                        </button>
        ...
        <div class="em-modal">
            ...
            <form id="formEditarAtributo" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nombre" id="modalAtributoNombre" class="form-control" required
                        autocomplete="off">
                </div>

                <div class="em-modal__actions">
                    <button type="button" class="btn btn-secondary" data-close-modal="modalEditarAtributo">
                        Cancelar
                    </button>
                    <button type="submit" class="btn btn-primary">
        ...
        <div class="em-modal">
            ...
            <form id="formEditarValor" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="valor" id="modalValorTexto" class="form-control" required
                        autocomplete="off">
                </div>

                <div class="mb-3">
                    <label class="form-label">Orden</label>
                    <input type="number" name="orden" id="modalValorOrden" class="form-control" min="0"
                        style="width:120px;">
                    <small class="text-muted">
                ...
                <div class="em-modal__actions">
                    <button type="button" class="btn btn-secondary" data-close-modal="modalEditarValor">
                        Cancelar
                    </button>
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-save me-1"></i> Guardar cambios

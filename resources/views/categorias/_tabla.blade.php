    ...
    <tr>
        ...
        <td class="text-end">
            @permiso('productos.gestionar')
                <a href="{{ route('categorias.edit', $categoria) }}" class="btn btn-outline-warning btn-sm" title="Editar">
                ...
                @else
                    <form action="{{ route('categorias.reactivar', $categoria) }}" method="POST" class="d-inline-block">
                        @csrf @method('PATCH')

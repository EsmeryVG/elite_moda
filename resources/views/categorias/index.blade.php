        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex justify-content-between align-items-center gap-3 mb-4 flex-wrap">
                ...
                <div style="position:relative; flex:1; max-width:320px;">
                    ...
                    <input type="text" id="buscadorCategorias" class="form-control"
                        placeholder="Buscar por nombre, código o descripción..." style="padding-left:36px;"
                ...
                <div class="d-flex gap-2">
                    ...
                    <button class="btn btn-sm em-filtro {{ request('estado') === 'activas' ? 'active' : '' }}"
                        data-filtro="activas" data-estado="activas">
                        Activas
                    </button>
                    <button class="btn btn-sm em-filtro {{ request('estado') === 'inactivas' ? 'active' : '' }}"
                        data-filtro="inactivas" data-estado="inactivas">
                        Inactivas
                    </button>
                </div>

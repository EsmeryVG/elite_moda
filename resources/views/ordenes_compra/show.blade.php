            ...
            <div class="card-body p-4">
                <div class="d-grid gap-2">
                    ...
                    @if($ordenes_compra->estado === 'borrador')
                        <a href="{{ route('ordenes_compra.edit', $ordenes_compra) }}"
                           class="btn btn-primary">
                            <i class="bi bi-pencil-square me-1"></i> Editar
                        </a>
                        <form action="{{ route('ordenes_compra.confirmar', $ordenes_compra) }}"
                              method="POST">
                            @csrf @method('PATCH')
                    ...
                    @if($ordenes_compra->esCancelable())
                        <form action="{{ route('ordenes_compra.cancelar', $ordenes_compra) }}"
                              method="POST">
                            @csrf @method('PATCH')

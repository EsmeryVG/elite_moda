...
@section('content')
    @php
        $lineasIniciales = $ordenes_compra->detalles->map(function ($d) {
            return [
    ...
    <form action="{{ route('ordenes_compra.update', $ordenes_compra) }}" method="POST" id="formOrden">
        @csrf @method('PUT')
                ...
                <div class="card page-card mb-4">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ $ordenes_compra->codigo }}" disabled>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="observaciones" class="form-control" rows="3">{{ old('observaciones', $ordenes_compra->observaciones) }}</textarea>
                        </div>
                ...
                <div class="card page-card">
                    <div class="card-body p-4">
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('ordenes_compra.show', $ordenes_compra) }}" class="btn btn-secondary">
                                Cancelar
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-lg-8">
                <div class="card page-card">
                    <div class="card-body p-4">
                        ...
                        <div id="contenedorLineas" class="lineas-container"
                            data-lineas="{{ json_encode($lineasIniciales) }}"></div>

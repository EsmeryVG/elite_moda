/* =====================================================
   Sucursales — JS del módulo
   ===================================================== */

const SucursalesModule = (function () {
    ...
    function bindBuscador() {
        const input = document.getElementById('buscadorSucursales');
        if (!input) return;
...
document.addEventListener('DOMContentLoaded', () => SucursalesModule.init());
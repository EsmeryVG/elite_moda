...
const AtributosModule = (function () {
    ...
    function bindPaginacion() {
        document.querySelectorAll('.ajax-page').forEach(link => {
            link.addEventListener('click', function (e) {
                ...
                cargarLista({ buscar: buscarActual, estado: estadoActual, page });
            });
        });
    }
    ...
    function bindFiltros() {
        document.querySelectorAll('.em-filtro').forEach(btn => {
            btn.addEventListener('click', function () {
                ...
                buscarActual = document.getElementById('buscadorAtributos')?.value.trim() ?? '';
    ...
    function bindExpandir() {
        document.querySelectorAll('.atributo-card__header').forEach(header => {
    ...
    function bindModalAtributo() {
        // Abrir modal
        document.querySelectorAll('[data-open-modal="editarAtributo"]').forEach(btn => {
            btn.addEventListener('click', function (e) {
                ...
                document.getElementById('modalAtributoNombre').value    = nombre;
                document.getElementById('formEditarAtributo').action    =
                    `/atributos/${id}`;

                document.getElementById('modalEditarAtributo').classList.add('open');
    ...
    function bindModalValor() {
        document.querySelectorAll('[data-open-modal="editarValor"]').forEach(btn => {
            btn.addEventListener('click', function (e) {
                e.stopPropagation();
    ...
    // ── Init ────────────────────────────────────────
    function init() {
        if (!document.getElementById('listaAtributos') &&
            !document.querySelector('.atributo-card')) return;

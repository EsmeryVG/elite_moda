...
const UsuariosModule = (function () {
    ...
    let rolActual     = new URLSearchParams(window.location.search).get('rol')    ?? '';
    ...
    function bindPaginacion() {
        document.querySelectorAll('.ajax-page').forEach(link => {
            link.addEventListener('click', function (e) {
                ...
                cargarTabla({ buscar: buscarActual, estado: estadoActual, rol: rolActual, page });
            });
        });
    }
    ...
    function bindFiltros() {
        document.querySelectorAll('.em-filtro').forEach(btn => {
            btn.addEventListener('click', function () {
                ...
                cargarTabla({ buscar: buscarActual, estado: estadoActual, rol: rolActual });
            });
        });

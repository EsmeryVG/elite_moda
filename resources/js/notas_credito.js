/* =====================================================
   Notas de Crédito — JS del módulo
   ===================================================== */

const NotasCreditoModule = (function () {
    ...
    function bindBuscador() {
        const input = document.getElementById("buscadorNotasCredito");
        if (!input) return;
...
document.addEventListener("DOMContentLoaded", () => NotasCreditoModule.init());

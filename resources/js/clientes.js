...
const ClientesModule = (function () {
    ...
    let grupoActual   = new URLSearchParams(window.location.search).get('grupo')  ?? '';
    ...
    function cargarTabla(params = {}) {
        ...
        if (params.grupo)  url.searchParams.set('grupo',  params.grupo);
    ...
    function bindPaginacion() {
        document.querySelectorAll('.ajax-page').forEach(link => {
            link.addEventListener('click', function (e) {
                ...
                cargarTabla({ buscar: buscarActual, estado: estadoActual, grupo: grupoActual, page });
            });
        });
    }
    ...
    function bindFiltros() {
        document.querySelectorAll('.em-filtro').forEach(btn => {
            btn.addEventListener('click', function () {
                ...
                cargarTabla({ buscar: buscarActual, estado: estadoActual, grupo: grupoActual });
            });
        });

...
return new class extends Migration
{
    ...
    Schema::create('ordenes_compra', function (Blueprint $table) {
        ...
        $table->enum('estado', ['borrador', 'confirmada', 'parcial', 'completada', 'cancelada'])
            ->default('borrador');
    ...
    Schema::create('detalle_ordenes_compra', function (Blueprint $table) {
        ...
        $table->boolean('itbis_incluido')->default(true);
    ...
    Schema::create('recepciones_mercancia', function (Blueprint $table) {
        ...
        $table->string('codigo')->unique()->nullable();
        $table->date('fecha');
        $table->enum('tipo', ['completa', 'parcial', 'no_conforme']);
        $table->text('observaciones')->nullable();

    ...
    public function store(Request $request)
    {
        ...
        DB::transaction(function () use ($request) {
            ...
            foreach ($request->lineas as $linea) {
                ...
                // Si tiene variante asociada y hay cantidad aceptada → actualizar stock
                if ($varianteId && $linea['cantidad_aceptada'] > 0) {
                    ...
                    // Actualizar costo en variante
                    $detalleOrden->variante?->update([
                        'costo' => $detalleOrden->precio_unitario,
                    ]);
                }
            }
